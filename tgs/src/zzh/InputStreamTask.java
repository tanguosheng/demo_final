...
public class InputStreamTask implements Runnable {
    ...
    private ConcurrentHashMap<String, AtomicInteger> apiMap;

    InputStreamTask(byte[] buff, ConcurrentHashMap<String, AtomicInteger> stMap, ConcurrentHashMap<String, AtomicInteger> apiMap) {
        this.buff = buff;
    ...
    public void run() {
        ...
        try {
            ...
            for (String line : strs) {
                ...
                AtomicInteger domainInteger = stMap.computeIfAbsent(domain, k -> new AtomicInteger(0));
                ...
                AtomicInteger urlInteger = apiMap.computeIfAbsent(url, k -> new AtomicInteger(0));
